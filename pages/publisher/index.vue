        ...
        <v-flex lg12>
          ...
          <template>
            ...
            >
              <v-card>
                <v-card-title>
                  <span class="headline">Xóa nhà xuất bản</span>
                </v-card-title>
                <v-divider></v-divider>
                <v-spacer></v-spacer>
            ...
            >
              <v-card>
                <v-card-title>
                  <span class="headline">Thêm mới nhà xuất bản</span>
                </v-card-title>
                <v-divider></v-divider>
                <v-card-text>
...
export default {
  ...
  methods: {
    ...
    initialize() {
        ...
        var config = {
          method: "get",
          url: "https://ptdapmback.herokuapp.com/v1/api/publishers?page=0&limit=100&sort=id",
          headers: {
    ...
    getDetail(objectId, requestType) {
      var config = {
        method: "get",
        url: "https://ptdapmback.herokuapp.com/v1/api/publishers/" + objectId,
        headers: {
    ...
    insertConfirm() {
      ...
      if (this.defaultData != null /*&& !this.validate(this.defaultData)*/) {
        ...
        var config = {
          method: "post",
          url: "https://ptdapmback.herokuapp.com/v1/api/publishers/",
          headers: {
    ...
    updateConfirm() {
      if (this.defaultData != null) {
        ...
        var config = {
          method: "put",
          url:
            "https://ptdapmback.herokuapp.com/v1/api/publishers/" + this.defaultData.id,
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer ' + accessToken,
          },
    ...
    removeConfirm() {
      if (this.defaultData.id > 0) {
        var config = {
            method: 'delete',
            url: "https://ptdapmback.herokuapp.com/v1/api/publishers/" + this.defaultData.id,
            headers: { 
              "Authorization": "Bearer " + localStorage.getItem("accessToken")
            },
        };
